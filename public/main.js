...
var routes = [
    ...
    { path: 'dashboard', canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]], component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_3__["DashboardComponent"] },
    { path: 'register', component: _register_register_component__WEBPACK_IMPORTED_MODULE_2__["RegisterComponent"] },
    { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"] },
    { path: 'profile', canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]], component: _profile_profile_component__WEBPACK_IMPORTED_MODULE_8__["ProfileComponent"] },
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [_auth_service__WEBPACK_IMPORTED_MODULE_0__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(toaster, auth, router) {
    ...
    LoginComponent.prototype.loginUser = function () {
        ...
        this.auth.login(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.toaster.success(data.msg, 'Login', {
                    timeOut: 2000,
                ...
                _this.toaster.error(data.msg, 'Login', {
                    timeOut: 2000,
                    positionClass: 'toast-bottom-left'
                });
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"], _auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], LoginComponent);
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(toaster, auth, router) {
        this.toaster = toaster;
        this.auth = auth;
        this.router = router;
    }
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(toaster, auth, router) {
        this.toaster = toaster;
        this.auth = auth;
        this.router = router;
    }
    ...
    RegisterComponent.prototype.onSubmit = function () {
        var _this = this;
        var _a = this, name = _a.name, username = _a.username, email = _a.email, password = _a.password;
        var user = { name: name, username: username, email: email, password: password };
    ...
    RegisterComponent.prototype.failed = function () {
        this.toaster.success('Submit', 'Form submitted', {
            timeOut: 30000
        });
    };
...
module.exports = __webpack_require__(/*! D:\Mohammed\project\mean-app\angular-src\src\main.ts */"./src/main.ts");
